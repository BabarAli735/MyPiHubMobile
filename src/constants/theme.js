...
export const ASSETS = {
  ...
  carousel1: require("../assets/images/hospitalbanner.jpg"),
  clinic2: require("../assets/images/clinic2.jpg"),
  clinic3: require("../assets/images/clinic3.jpg"),
  doctor2: require("../assets/images/doctor2.jpg"),
  doctor3: require("../assets/images/doctor3.jpg"),
  doctor4: require("../assets/images/doctor4.jpg"),
  doctor5: require("../assets/images/doctor5.jpg"),
  carousel2: require("../assets/images/pharmacy1.jpg"),
  carousel3: require("../assets/images/pharmacy2.jpg"),
  ...
  doctor: require("../assets/images/doctor-avatar.jpg"),
