      ...
      <FlatList
        ListHeaderComponent={
          <Stack>
            ...
            <Details />
            <FirstCard
              title="Adolescent Weight Loss Surgery"
              info="Doctors at MyPiHUB USIM’s Adolescent Healthy Weight Program provide weight loss surgery for teens."
            />
            <Team />
            <Text
              textAlign={"center"}
  ...
  return (
    <VStack alignItems={"center"} space={2} my="2">
      <VStack alignItems="center" space={2}>
        ...
        <Text>Our doctors help teenagers achieve a healthy weight.</Text>
      </VStack>
      <Button row gradient={gradients.primary}>
        <Block row align="center" justify="center" paddingHorizontal={sizes.sm}>
          <MyText size={12} white bold transform="uppercase">
  ...
  return (
    <VStack space={2} my="2">
      ...
      <VStack space={4}>
        ...
        <Text>
          To help your child lose weight, we start with diet and lifestyle
