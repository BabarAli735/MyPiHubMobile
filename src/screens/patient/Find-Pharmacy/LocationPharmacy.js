    ...
    <Screen style={styles.container}>
      ...
      {tab === 0 && (
        <FlatList
          ...
          renderItem={({ item }) => (
            <HospitalCard
              title="Adolescent Healthy Weight Program"
              info="USIM provide outstanding healthcare services for people by using smart technological ICT solutions."
              address="135 East 31st Street, New York, NY 10016"
              phone="212-263-5940"
            />
          )}
        />
