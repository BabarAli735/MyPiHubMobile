      ...
      <FlatList
        ListHeaderComponent={
          <Stack>
            ...
            <HospitalCardSecond />
            <Image source={assets.carousel1} />
            <SimpleCard
              title="Ranked Among Best Hospitals"
              info="We’re one of the top-ranked hospitals in the country by Malysia News & World Report."
            />
            <SimpleCard
              title="Excellence in Nursing"
              info="We have achieved Magnet® recognition from the American Nurses Credentialing Center four consecutive times."
            />
            <SimpleCard
              title="Highest-Quality Healthcare"
              info="We are recognized by The Joint Commission for our excellence in perinatal, palliative, stroke, and ventricular assist device care."
            />
        ...
        <TouchableOpacity onPress={() => setShow(!show)}>
          <HStack alignItems="center" space={2} justifyContent="space-between">
            <VStack>
              ...
              <Text>135 East 31st Street New York, NY 10016</Text>
            </VStack>
            <Center
              p="1"
              borderRadius={"full"}
...
const Details = ({}) => {
  ...
  return (
    <VStack space={2} my="2">
          ...
          <Stack w="5/6">
            <HStack alignItems={"center"} space={2} mb={2}>
              <Text fontWeight="bold" fontSize="md" color={colors.secondary}>
                My Stay: Welcome to Klinik Pakar Kesihatan USIM Profile
              </Text>
            </HStack>
            <Text>
      ...
      <VStack space={4}>
        <Text>
          At MyPiHUB USIM’s Hospital, our doctors, nurses, and other medical
          professionals use a team approach to provide the highest level of care
          to people from New York City and around the world. We want our
          patients and their families to feel comfortable during their stay. We
          have received The Joint Commission’s Gold Seal of Approval® in
          recognition of our commitment to providing our patients with the
          highest quality care.
        </Text>
        <Image source={assets.carousel1} />
        <Text>
          At Klinik Pakar Kesihatan USIM, we have more than 300 beds for people
          who need inpatient care. We also have 66 state-of-the-art operating
          rooms an advanced critical care unit, and a Neonatal Intensive Care
          Unit (NICU) for our tiniest patients. We are also home to the
          Comprehensive Stroke Center and Ronald O. Perelman Center for
          Emergency Services, where our emergency medicine specialists provide
          advanced care for adults and children. More than 6,500 babies are born
          each year at Klinik Pakar Kesihatan USIM. We have earned the
          Baby-Friendly designation from Baby-Friendly USA in recognition of our
          care and support for breastfeeding mothers and their babies. Opened in
          1963 as University Hospital, our facility was renamed Klinik Pakar
          Kesihatan USIM in 1989 in recognition of two prominent and generous
          benefactors—brothers Laurence A. and Preston Robert USIM.
        </Text>
      </VStack>
    </VStack>
  );
