              ...
              {tab == 1 ? (
                ...
                <VStack>
                  <RewardsCard
                    ...
                    expireDate={dayjs()}
                    logo={assets.avatar1}
                    promoCode={"Lab tests fee 30% off"}
                    qrData="This is a promo code from Clinic about Lab tests fee 30% off"
                    title={"From Clinics"}
                  />
                  <RewardsCard
                    discount={50}
                    expireDate={dayjs()}
                    logo={assets.avatar1}
                    promoCode={"Consultation Fee 50% off"}
                    qrData="This is a promo code from Doctor about Consultation Fee 50% off"
                    title="From Doctors"
                  />
                  <RewardsCard
                    discount={40}
                    expireDate={dayjs()}
                    logo={assets.avatar1}
                    promoCode={"Buy your medicines at 40% off"}
                  ...
                  <RewardsCard
                    ...
                    expireDate={dayjs()}
                    logo={assets.avatar1}
                    promoCode={"Buy Healthy Diet food at 90% off in Grab Food"}
                    qrData="Buy Healthy Diet food at 90% off in Grab Food"
                    title="From Marketplaces"
                  />
                </VStack>
              )}
            </VStack>
